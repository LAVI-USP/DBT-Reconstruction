...
void projectionDDb(double* const h_pProj, double* const h_pVolume, double* const h_pTubeAngle, double* const h_pDetAngle, const unsigned int nProj, const unsigned int nPixX,
